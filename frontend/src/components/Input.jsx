          ...
          {TextArea === false ? (
            <div className="relative w-full">
              <input
                ...
                } py-2 text-gray-700 bg-[#FFFDF9] border border-gray-300 rounded-md focus:ring-[#FFC20E] focus:border-[#FFC20E] outline-none transition duration-200 ease-in-out hover:shadow-md ${className}`}
                {...(onChange
