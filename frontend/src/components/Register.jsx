...
import AstrologyWheel from "../assets/AstrologyWheel.png";
import Logo from "../assets/Logo.png"

export const RegisterAstrologer = ({ UpdateProfile = false }) => {
        ...
        <div className=" h-full  w-full bg-white/80 rounded-xl lg:px-12  shadow-xl border border-white/50 ">
          {UpdateProfile === false ? (
            <div className="px-6 py-4">
              <span className="inline-block px-4 py-2 coustard-h1 rounded-full bg-amber-100 text-amber-700 text-sm font-medium">
